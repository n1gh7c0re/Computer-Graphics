    ...
    _In_ int       nCmdShow)
{
    ...
    HWND hWnd = FindWindow(L"MyClass", L"Тишковец Сергей – ДЗ 8");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(L"MyClass", L"Тишковец Сергей – ДЗ 8", WS_OVERLAPPEDWINDOW,
    ...
    UpdateWindow(hWnd);
    SetWindowText(hWnd, L"Тишковец Сергей – ДЗ 8");
