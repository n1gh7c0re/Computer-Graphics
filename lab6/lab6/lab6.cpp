    ...
    _In_ int       nCmdShow)
{
    ...
    HWND hWnd = FindWindow(L"MyClass", L"Тишковец Сергей – ДЗ 6");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(L"MyClass", L"Тишковец Сергей – ДЗ 6", WS_OVERLAPPEDWINDOW,
    ...
    UpdateWindow(hWnd);
    SetWindowText(hWnd, L"Тишковец Сергей – ДЗ 6");
...
HRESULT InitDirectX(HWND hWnd)
{
    ...
    if (SUCCEEDED(result))
    {
        ...
        m_sceneBuffer.lights[0].pos = Point4f{ 0, 1.5f, 0, 1 };
