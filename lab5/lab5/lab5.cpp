    ...
    _In_ int       nCmdShow)
{
    ...
    HWND hWnd = FindWindow(L"MyClass", L"Тишковец Сергей – ДЗ 5");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(L"MyClass", L"Тишковец Сергей – ДЗ 5", WS_OVERLAPPEDWINDOW,
    ...
    UpdateWindow(hWnd);
    SetWindowText(hWnd, L"Тишковец Сергей – ДЗ 5");
...
HRESULT InitRect()
{
    ...
    if (SUCCEEDED(result))
    {
        ...
        geomBuffer.color = Point4f{ 1.0f, 0.0f, 0.0f, 1.0f };
        ...
        if (SUCCEEDED(result))
        {
            ...
            geomBuffer.color = Point4f{ 0.0f, 0.0f, 1.0f, 1.0f };
